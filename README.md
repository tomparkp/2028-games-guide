...
| ---------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Significance** | 30%    | How much the session matters in context: round type (e.g. gold medal vs preliminary), sport popularity tier, and whether multiple finals/medals happen in one session.           |
