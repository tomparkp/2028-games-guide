...
export function Nav() {
  return (
    <div className="relative overflow-hidden px-6 pt-12 pb-6 text-center max-md:px-4 max-md:pt-10">
      <a
        href="https://github.com/tomparkp/2028-games-guide"
        target="_blank"
      ...
      <p className="text-ink3 relative mx-auto mt-2 max-w-[600px] text-[0.72rem] leading-normal font-light max-md:px-2">
        ...
        , open-source project not affiliated with any official organizing body. Session data is
        scraped from public materials and may be inaccurate or outdated. AI ratings are subjective
        and should not be used as a sole basis for decisions. Always verify against official
        sources.
      </p>
    </div>
  )
